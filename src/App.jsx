...
const GLOBAL_STYLES = `
  ...
  .toast-msg { font-size: 9px; letter-spacing: 0.08em; color: rgba(255,255,255,0.4); line-height: 1.5; }
  .toast-close { background: none; border: none; color: rgba(255,255,255,0.25); cursor: pointer; padding: 2px; flex-shrink: 0; transition: color 0.2s; }
  .toast-close:hover { color: rgba(255,255,255,0.7); }
  .toast-bar { position: absolute; bottom: 0; left: 0; height: 1px; background: #C9A96E; animation: toastProgress linear forwards; }
  ...
  .mini-cart {
    position: fixed; top: 80px; right: 0; z-index: 85;
  ...
  .mini-cart-header {
    ...
    position: sticky; top: 0; background: #0f0d0a; z-index: 1;
  }
  .mc-title { font-family: 'Overpass Mono', monospace; font-size: 9px; letter-spacing: 0.5em; text-transform: uppercase; color: rgba(255,255,255,0.6); }
  .mc-count { font-family: 'Overpass Mono', monospace; font-size: 8px; letter-spacing: 0.3em; color: #C9A96E; }
  .mc-close { background: none; border: none; color: rgba(255,255,255,0.3); cursor: pointer; padding: 4px; transition: color 0.2s; }
  ...
  .mc-item-img { aspect-ratio: 3/4; overflow: hidden; background: #111008; }
  .mc-item-img img { width: 100%; height: 100%; object-fit: cover; }
  .mc-item-cat { font-family: 'Overpass Mono', monospace; font-size: 7px; letter-spacing: 0.45em; text-transform: uppercase; color: rgba(255,255,255,0.2); margin-bottom: 5px; }
  .mc-item-name { font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.04em; text-transform: uppercase; color: rgba(255,255,255,0.65); line-height: 1.45; margin-bottom: 8px; }
  .mc-item-qty { font-family: 'Overpass Mono', monospace; font-size: 7.5px; letter-spacing: 0.3em; color: rgba(255,255,255,0.25); }
  .mc-item-price { font-family: 'Overpass Mono', monospace; font-size: 10px; font-weight: 600; color: #fff; white-space: nowrap; }
  .mc-footer { padding: 20px 24px; border-top: 1px solid rgba(255,255,255,0.06); position: sticky; bottom: 0; background: #0f0d0a; }
  .mc-total-row { display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 16px; }
  .mc-total-label { font-family: 'Overpass Mono', monospace; font-size: 8px; letter-spacing: 0.45em; text-transform: uppercase; color: rgba(255,255,255,0.35); }
  .mc-total-val { font-family: 'Overpass Mono', monospace; font-size: 18px; font-weight: 600; color: #fff; }
  .mc-cta { display: block; width: 100%; padding: 16px; background: #C9A96E; border: none; font-family: 'Overpass Mono', monospace; font-size: 9px; letter-spacing: 0.5em; text-transform: uppercase; color: #080705; cursor: pointer; text-align: center; text-decoration: none; transition: background 0.2s; }
  .mc-cta:hover { background: #d4b87a; }
  .mc-shop { display: block; width: 100%; padding: 12px; background: transparent; border: 1px solid rgba(255,255,255,0.08); font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.45em; text-transform: uppercase; color: rgba(255,255,255,0.3); cursor: pointer; text-align: center; text-decoration: none; margin-top: 8px; transition: border-color 0.3s, color 0.3s; }
  .mc-shop:hover { border-color: rgba(255,255,255,0.25); color: rgba(255,255,255,0.75); }
  .mc-empty { padding: 60px 24px; text-align: center; font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.45em; text-transform: uppercase; color: rgba(255,255,255,0.2); }
  ...
  .ann-text { font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.45em; text-transform: uppercase; text-align: center; }
  .ann-text a { color: #080705; text-decoration: underline; text-underline-offset: 3px; }
  .ann-close { position: absolute; right: 20px; background: none; border: none; color: rgba(8,7,5,0.5); cursor: pointer; padding: 4px; transition: color 0.2s; }
  .ann-close:hover { color: #080705; }

  /* ── RECENTLY VIEWED ── */
  .rv-root { background: #080705; padding: 80px 6vw; border-top: 1px solid rgba(255,255,255,0.05); }
  .rv-inner { max-width: 1440px; margin: 0 auto; }
  .rv-header { display: flex; align-items: center; gap: 14px; margin-bottom: 32px; }
  .rv-header-line { width: 28px; height: 1px; background: rgba(255,255,255,0.15); }
  .rv-header-text { font-family: 'Overpass Mono', monospace; font-size: 9px; letter-spacing: 0.55em; text-transform: uppercase; color: rgba(255,255,255,0.28); }
  .rv-strip { display: flex; gap: 2px; overflow-x: auto; scrollbar-width: none; }
  .rv-strip::-webkit-scrollbar { display: none; }
  .rv-card { flex-shrink: 0; width: 160px; background: #0d0b09; cursor: pointer; transition: background 0.25s; }
  .rv-card:hover { background: #111008; }
  ...
  .rv-card-name { font-family: 'Overpass Mono', monospace; font-size: 8px; letter-spacing: 0.04em; text-transform: uppercase; color: rgba(255,255,255,0.5); line-height: 1.5; margin-bottom: 6px; }
  .rv-card-price { font-family: 'Overpass Mono', monospace; font-size: 9px; font-weight: 600; color: rgba(255,255,255,0.7); }
  ...
  .ng-link { display: inline-flex; align-items: center; gap: 10px; font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.45em; text-transform: uppercase; color: rgba(255,255,255,0.25); text-decoration: none; transition: color 0.3s; }
  ...
  .ng-crumb { font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.35em; text-transform: uppercase; color: rgba(255,255,255,0.45); }
  ...
  .tr-view-all { font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.4em; text-transform: uppercase; color: rgba(255,255,255,0.3); text-decoration: none; display: flex; align-items: center; gap: 8px; transition: color 0.3s; }
  ...
  .tr-rank-badge { position: absolute; top: 12px; left: 12px; font-family: 'Overpass Mono', monospace; font-size: 7px; letter-spacing: 0.3em; color: #C9A96E; background: rgba(8,7,5,0.85); border: 1px solid rgba(201,169,110,0.25); padding: 4px 8px; }
  ...
  .na-link { font-family: 'Overpass Mono', monospace; font-size: 8.5px; letter-spacing: 0.4em; text-transform: uppercase; color: rgba(255,255,255,0.3); text-decoration: none; transition: color 0.3s; display: flex; align-items: center; gap: 8px; }
  ...
  .na-card { background: #0d0b09; display: flex; flex-direction: column; cursor: pointer; transition: background 0.25s; }
  .na-card:hover { background: #111008; }
    ...
    <div className="toast-stack">
      {toasts.map(t => (
        <div key={t.id} className={`toast${t.exiting ? ' exit' : ''}`} style={{ position: 'relative', overflow: 'hidden' }}>
          <Sparkles size={13} className="toast-icon" style={{ color: '#C9A96E', flexShrink: 0 }} />
  ...
  return (
    <>
      ...
      <div
        ...
        onClick={onClose}
        style={{ background: open ? 'rgba(0,0,0,0.3)' : 'transparent', transition: 'background 0.3s' }}
      />
...
const App = () => {
  ...
  /* Open mini cart & toast when item added */
  useEffect(() => {
